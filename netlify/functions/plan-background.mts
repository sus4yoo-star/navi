...
PD처럼: 그것을 내 채널 색깔에 맞춰 '이렇게 만들어라'(제목·첫3초 훅·형식)로 구체화하세요. 남의 걸 베끼는 게 아니라 내 채널 버전으로.
클리셰·과장·이모지 금지. 아래 JSON 하나만 출력. 그 외 텍스트·코드펜스 금지.
{
 ...
 "ideas":[{"title":"내 채널용 영상 제목","format":"쇼츠","hook":"첫 3초 훅","why":"왜 먹힐지 — 잘된영상/댓글 근거","source":"트렌드"}]
}
