...
근거는 오직 [내 채널], [후보 채널들], [그 채널들의 시청자 댓글]뿐입니다. 수치·사실·댓글을 지어내지 마세요.
ideas는 영감 채널에서 지금 먹히는 기법과 댓글에 드러난 시청자 수요에 근거하되, 내 채널의 색깔·톤으로 변주하세요(왜에 그 근거를 드러낼 것). 모든 출력은 한국어.
...
channels: 내 채널이 '차용할 수 있는 영감'을 주는 채널 4~6개를 고르세요(name은 후보에 있는 그대로). 비즈니스에서 타 분야 벤치마킹으로 성공하듯, 꼭 같은 분야가 아니어도 됩니다.
 ...
 · apply = 그 기법을 '내 채널에 어떻게 차용할지' 구체적으로(내 소재·톤으로 변주).
