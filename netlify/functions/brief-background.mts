...
클리셰·과장·이모지 금지. 아래 JSON 하나만 출력. 그 외 텍스트·코드펜스 금지.
{
 ...
 "inspirations":[{"from":"코호트 채널명 그대로","insight":"이 채널이 지금 이렇게 해서 뜬다","apply":"내 채널엔 이렇게 적용"}],
...
각 배열은 3개 내외로 간결하게. ideas는 3개. inspirations의 from은 반드시 코호트에 있는 채널명. source는 "트렌드"/"댓글"/"성과" 중.`;
