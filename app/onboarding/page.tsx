      ...
      <div className="nv-wrap" style={{ paddingTop: 24 }}>
        {!ready ? (
          ...
          <>
            ...
            {proposed && (
              <div className="nv-card" style={{ background: C.accentTint, borderColor: "#D8D3F6" }}>
...
.nv-topbar{background:rgba(246,245,242,.8);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);border-bottom:1px solid ${C.line}}
...
.nv-btn{background:${C.accent};color:#fff;border:none;border-radius:11px;padding:13px 17px;font-size:15px;font-weight:600;cursor:pointer;font-family:inherit;transition:box-shadow .16s,transform .05s,filter .16s;letter-spacing:-.01em;box-shadow:0 6px 18px -8px rgba(75,67,214,.5)}
.nv-btn:hover:not(:disabled){box-shadow:0 10px 26px -8px rgba(75,67,214,.5);filter:brightness(1.05)}.nv-btn:active:not(:disabled){transform:translateY(1px)}.nv-btn:disabled{opacity:.45;cursor:default}
